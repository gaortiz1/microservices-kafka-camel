...
class PaymentServiceImpl(
    ...
    @Transactional
    override fun chargePayment(chargePaymentRequest: ChargePaymentRequest): Payment {
    ...
    @Transactional
    override fun refundPayment(refundPaymentRequest: RefundPaymentRequest): Payment {
